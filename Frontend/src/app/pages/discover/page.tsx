...
export default function Discover() {
  ...
  useEffect(() => {
    ...
    const fetchTopics = async () => {
      ...
      try {
        const token = session.password;
        const response = await axios.get("http://localhost:5000/GetTopics", {
          headers: {
            token: token,
          },
        });
              ...
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <div className="flex items-center justify-between">
                    <AnimatedDiv direction="left" duration={0.3}>
                      <SearchTab
                        ...
                        onOptionSelect={(option) => {
                          ...
                          fetchEvents({ region: option?.label });
                        }}
                      />
                    </AnimatedDiv>
                      ...
                      <AnimatedDiv direction="right">
                        <div className="p-2">
                          <Cross1Icon
                            ...
                            onClick={() => resetSelection(setSelectedLocation)}
                          />
                        </div>
                      </AnimatedDiv>
                    )}
                    ...
                    <AnimatedDiv direction="left" duration={0.3}>
                      <SearchTab
                        ...
                        onOptionSelect={(option) => {
                          ...
                          fetchEvents({ label: option?.label });
                        }}
                      />
                    </AnimatedDiv>
                    ...
                    {selectedTopic && (
                      <AnimatedDiv direction="right">
                        <div className="p-2">
                          <Cross1Icon
                            className="w-6 h-6 text-secondarycolor hover:text-white transition-colors cursor-pointer"
                            onClick={() => resetSelection(setSelectedTopic)}
                          />
                        </div>
                      </AnimatedDiv>
                    )}
                    ...
                    <AnimatedDiv direction="left" duration={0.3}>
                      <DatePicker
                        ...
                        onChange={(dates: any) => {
                          ...
                          fetchEvents({
                            startTime: dates[0]?.toISOString().split("T")[0],
                            endTime: dates[1]?.toISOString().split("T")[0],
                          });
                        }}
                    ...
                    {selectedTimeRange[0] && selectedTimeRange[1] && (
                      <AnimatedDiv direction="right">
                        <div className="p-2">
                          <Cross1Icon
                            className="w-6 h-6 text-secondarycolor hover:text-white transition-colors cursor-pointer"
                            onClick={() => resetSelection(setSelectedTimeRange)}
                          />
                        </div>
                      </AnimatedDiv>
                    )}
                ...
                <AccordionContent>
                  <div className="flex items-center justify-between">
                    <AnimatedDiv direction="left" duration={0.3}>
                      ...
                      <div className="mt-2">
                      <div className="justify-center items-center flex"><span>To</span></div>
                      <input
                          type="number"
                          name="maxPrice"
                        ...
                        <AnimatedDiv direction="right">
                          <div className="p-2">
                            <Cross1Icon
                              className="w-6 h-6 text-secondarycolor hover:text-white transition-colors cursor-pointer"
                              onClick={() =>
                                resetSelection(setSelectedPriceRange)
                              }
                            />
                          </div>
                        </AnimatedDiv>
