      ...
      <div className="flex border- border-white p-5">
        <div className="flex-col justify-center ">
          ...
          <div className="p-2 pt-8 pb-4">
            <h1 className="text-white font-bold text-4xl">{events?.title}</h1>
          </div>
          <Tabs defaultValue="description">
            ...
            <TabsContent value="description">
              <AnimatedDiv direction="top" delay={0.1} duration={0.8}>
            ...
            <TabsContent value="ticket">
              <ScrollArea className="max-w-3xl h-[40vw] rounded-md py-4 text-white ">
                {events?.tickets.map((ticket, index) => (
                  <div key={index} className="p-2 m-1 hover:m-0 transition-all">
                    <AnimatedDiv
                      direction="top"
                      delay={0.1 * index}
                      duration={0.8}
                        ...
                        <div className="flex items-center justify-between min-w-[25vw]">
                          <div>
                            ...
                            <div className="text-md font-light">
                              <h1>
                                Berakhir pada {formatDate(events?.end_date)}
                              </h1>
                            </div>
                          </div>
                          <div>
